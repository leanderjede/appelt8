...
const JobDescription = () => {
      ...
      <div className="min-h-screen bg-[#f8f5f0]">
        ...
        <div className="relative bg-red-900 text-white">
          <div className="container mx-auto px-6 py-24 md:py-32 lg:py-40 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">BODENLEGER <span className="text-yellow-400">(M/W/D)</span></h1>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      ...
      <p className="text-gray-700">Verlegen von Bodenbelägen wie Laminat, Parkett, Vinyl und Teppich</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Vorbereitung des Untergrunds (z. B. Spachteln, Schleifen, Grundieren)</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Zuschneiden und Anpassen von Bodenbelägen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Montage von Sockelleisten und Übergangsprofilen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Sorgfältige Ausführung und Kontrolle der Arbeiten</p>
    </li>
  </ul>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Erfahrung im Bereich Bodenverlegung von Vorteil</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Saubere, präzise und selbstständige Arbeitsweise</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Teamgeist, Zuverlässigkeit und handwerkliches Geschick</p>
    </li>
  </ul>

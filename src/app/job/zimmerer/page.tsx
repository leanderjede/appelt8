...
const JobDescription = () => {
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      ...
      <p className="text-gray-700">Herstellung und Montage von Holzkonstruktionen wie Dachstühlen, Fachwerken und Holzrahmenbauten</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Einbau von Dachfenstern, Decken- und Wandverkleidungen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Bearbeitung von Holz und Holzwerkstoffen mit modernen Maschinen und Werkzeugen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Zuschnitt, Verbindung und Montage der Bauteile nach Plan</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Qualitätskontrolle und Sicherstellung der Maßgenauigkeit auf der Baustelle</p>
    </li>
  </ul>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Abgeschlossene Ausbildung als Zimmerer/Zimmerin oder vergleichbare Qualifikation</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Erfahrung im Umgang mit Holz sowie Kenntnisse im Abbund und in der Montage</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Teamfähigkeit, handwerkliches Geschick und körperliche Belastbarkeit</p>
    </li>
  </ul>

...
const JobDescription = () => {
      ...
      <div className="min-h-screen bg-[#f8f5f0]">
        ...
        <div className="relative bg-red-900 text-white">
          <div className="container mx-auto px-6 py-24 md:py-32 lg:py-40 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">DACHDECKER<span className="text-yellow-400">(M/W/D)</span></h1>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      ...
      <p className="text-gray-700">Eindecken von Dächern mit Ziegeln, Schiefer, Bitumen oder Metall</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Abdichtungsarbeiten an Flach- und Steildächern</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Montage von Dachfenstern, Solaranlagen und Dämmmaterialien</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Reparatur- und Instandhaltungsarbeiten an Dächern und Fassaden</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Sicherstellung der Arbeitssicherheit und Qualität auf der Baustelle</p>
    </li>
  </ul>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Abgeschlossene Ausbildung als Dachdecker oder einschlägige Berufserfahrung</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Schwindelfreiheit und sicheres Arbeiten in der Höhe</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Teamfähigkeit, Zuverlässigkeit und handwerkliches Geschick</p>
    </li>
  </ul>

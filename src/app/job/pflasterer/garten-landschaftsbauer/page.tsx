...
const JobDescription = () => {
      ...
      <div className="min-h-screen bg-[#f8f5f0]">
        ...
        <div className="relative bg-red-900 text-white">
          <div className="container mx-auto px-6 py-24 md:py-32 lg:py-40 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Pflaster / Garten-Landschaftsbauer<span className="text-yellow-400">(M/W/D)</span></h1>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      ...
      <p className="text-gray-700">Pflasterarbeiten im öffentlichen und privaten Bereich (z. B. Wege, Einfahrten, Terrassen)</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Anlage und Pflege von Grünflächen, Gärten und Außenanlagen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Verbau von Natursteinen, Randsteinen, Platten und Bordsteinen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Vorbereitung des Untergrunds, Erd- und Entwässerungsarbeiten</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Bedienung von Maschinen und Geräten im GaLaBau</p>
    </li>
  </ul>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Abgeschlossene Ausbildung im Garten- und Landschaftsbau, als Pflasterer oder vergleichbare Qualifikation</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Erfahrung im Umgang mit Maschinen und Geräten von Vorteil</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Teamfähigkeit, Zuverlässigkeit und körperliche Belastbarkeit</p>
    </li>
  </ul>

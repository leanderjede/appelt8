...
const JobDescription = () => {
      ...
      <div className="min-h-screen bg-[#f8f5f0]">
        ...
        <div className="relative bg-red-900 text-white">
          <div className="container mx-auto px-6 py-24 md:py-32 lg:py-40 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">MAURER <span className="text-yellow-400">(M/W/D)</span></h1>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      ...
      <p className="text-gray-700">Errichtung von Mauerwerken aus verschiedenen Materialien wie Ziegel, Beton oder Naturstein</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Herstellung von Fundamenten, Decken und Wänden</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Verputzen und Ausgleichen von Wand- und Bodenflächen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Arbeiten nach Bauplänen und technischen Zeichnungen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Sicherstellung von Maßgenauigkeit und Qualität auf der Baustelle</p>
    </li>
  </ul>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Abgeschlossene Ausbildung als Maurer oder vergleichbare Qualifikation</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Gute Kenntnisse im Lesen von Bauplänen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>

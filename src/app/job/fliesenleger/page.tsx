...
const JobDescription = () => {
      ...
      <div className="min-h-screen bg-[#f8f5f0]">
        ...
        <div className="relative bg-red-900 text-white">
          <div className="container mx-auto px-6 py-24 md:py-32 lg:py-40 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">FLIESENLEGER <span className="text-yellow-400">(M/W/D)</span></h1>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      ...
      <p className="text-gray-700">Verlegen von Wand- und Bodenfliesen im Innen- und Außenbereich</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Vorbereitung der Untergründe (Spachteln, Abdichten, Grundieren)</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Zuschneiden und Anpassen von Fliesen mit Maschinen und Werkzeugen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Verfugen und Versiegeln der Flächen</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Sicherstellung einer sauberen und präzisen Ausführung</p>
    </li>
  </ul>
  ...
  <ul className="space-y-4 mb-8">
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Erfahrung im Fliesenlegen oder abgeschlossene Ausbildung von Vorteil</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
      <p className="text-gray-700">Selbstständige und sorgfältige Arbeitsweise</p>
    </li>
    <li className="flex items-start">
      <div className="flex-shrink-0 h-6 w-6 text-yellow-500 mr-3">•</div>
